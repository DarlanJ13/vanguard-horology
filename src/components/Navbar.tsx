...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      ...
      >
        {/* Link com contêiner estrito para anular o espaço invisível da logo */}
        <Link
          to="/"
          className="flex items-center h-full max-h-14 overflow-hidden group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C8A45A] rounded"
          aria-label="Vanguard Horology Co. Página inicial"
        >
          <img 
            src="/logo.png" 
            alt="Vanguard Horology Co. Logo" 
            className="h-28 min-w-[140px] object-contain my-[-32px] transition-all duration-300 group-hover:brightness-110" 
          />
        </Link>
